...
export const productsData = [
  // ── Indian — मसाला / spice blends & prepared food (18) ───────────────────────────
  { id: 101, name: 'Chicken & Ragi Sangati', nativeDesc: 'చికెన్, రాగి సంగటి', img: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&q=80&w=800', culture: 'hi', score_authenticity: 9.8, score_distance: 1.5, score_price: 12.50, store: 'Andhra Spice Restaurant, Newcastle', location: 'Newcastle upon Tyne', retailerName: 'Andhra Spice Restaurant', retailerUrl: 'https://www.google.com/maps', retailerLogo: 'https://www.google.com/s2/favicons?domain=google.com&sz=64', productUrl: '', tags: ['Indian', 'Prepared Food', 'Andhra', 'Rayalaseema', 'Restaurant'], reviews: 145, keywords: ['chicken', 'ragi', 'sangati', 'andhra', 'rayalaseema', 'restaurant', 'prepared', 'చికెన్'], reviewSamples: [{ author: 'Kiran K.', rating: 10, text: 'Tastes exactly like my grandmother\'s cooking in Kadapa!' }, { author: 'Harsha V.', rating: 9.5, text: 'The most authentic Rayalaseema food in the UK.' }] },
